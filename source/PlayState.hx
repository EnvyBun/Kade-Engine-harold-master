	...
	override public function create()
	{
		...
		switch(SONG.song.toLowerCase())
		{
            ...
            case 'harold_beatbox':
            {
                    defaultCamZoom = 0.9;
                    curStage = 'totaldrama';
                    var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('harold/stageback'));
                    bg.antialiasing = true;
                    bg.scrollFactor.set(0.9, 0.9);
                    bg.active = false;
                    add(bg);

                    var stageFront:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('harold/stagefront'));
                    ...
                    var stageCurtains:FlxSprite = new FlxSprite(-500, -300).loadGraphic(Paths.image('harold/stagecurtains'));
