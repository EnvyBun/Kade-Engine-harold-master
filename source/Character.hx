...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
            ...
            case 'harold':
                tex = Paths.getSparrowAtlas('harold/harold_assets');
                frames = tex;
                animation.addByPrefix('idle', 'Harold idle dance', 24);
                animation.addByPrefix('singUP', 'Harold Sing Note UP', 24);
                animation.addByPrefix('singRIGHT', 'Harold Sing Note RIGHT', 24);
                animation.addByPrefix('singDOWN', 'Harold Sing Note DOWN', 24);
                animation.addByPrefix('singLEFT', 'Harold Sing Note LEFT', 24);
